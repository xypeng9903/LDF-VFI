...
def get_sequence_parallel_group_index():
    """Return the index of the sequence parallel group the caller rank belongs to."""
    rank = dist.get_rank()
    sp_world_size = get_sequence_parallel_world_size()
    return rank // sp_world_size


def get_sequence_parallel_src_rank():
    group_idx = get_sequence_parallel_group_index()
    sp_world_size = get_sequence_parallel_world_size()
    return group_idx * sp_world_size
